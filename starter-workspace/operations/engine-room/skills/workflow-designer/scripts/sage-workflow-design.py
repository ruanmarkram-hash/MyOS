...
================================================
6 questions from user. Sage fills the rest intelligently.
Review step at end for corrections.

Usage:
  python sage-workflow-design.py
  python sage-workflow-design.py --type compliance --name "Quarterly Audit"
  python sage-workflow-design.py --path /path/to/workflow/folder
"""
...
# ============================================================
# WORKSPACE KNOWLEDGE — Sage fills these automatically
# ============================================================

WORKSPACE_ROOT = "~/workspace"

# Folder structure: [root]/[operation-or-project]/[workflow-name]/brief.md + output/
# e.g. sonke-support/compliance/quarterly-internal-audit/brief.md
#      sonke-support/compliance/quarterly-internal-audit/output/
RESOURCE_PATHS = {
    "compliance": {
        "parent": "sonke-support/compliance",
        "data": "sonke-support/compliance/data/",
        "ndis": "example-org/compliance/reference/standards/",
        "legislation": "sonke-support/compliance/data/legislation/",
    },
    "recruitment": {
        "parent": "sonke-support/recruitment",
        "data": "sonke-support/recruitment/data/",
    },
    "incident": {
        "parent": "sonke-support/incident-management",
        "data": "sonke-support/incident-management/data/",
    },
    "bsp": {
        "parent": "sonke-support/behaviour-support-plans",
        "data": "sonke-support/behaviour-support-plans/data/",
    },
    "business": {
        "parent": "sonke-support/business-management",
        "data": "sonke-support/business-management/data/",
    },
    "onboarding": {
        "parent": "sonke-support/recruitment",
        "data": "sonke-support/recruitment/data/",
    ...
    "code": {
        "parent": "projects/sonke-hub",
        "data": "projects/sonke-hub/data/",
    },
    "project": {
        "parent": "projects",
        "data": "projects/",
...
# Default escalation
DEFAULT_ESCALATION = "your name"
DEFAULT_REVIEWER = "your name (final approval + sign-off)"
...
def banner():
    ...
    print("6 questions from you. Sage fills the rest.")
    print("=" * 60)
    print()
...
def infer_blockers(wf_type):
    ...
    blockers = {
        "compliance": [
            ...
            "regulatory standards may have been updated mid-quarter (check for changes)",
...
def infer_decision_trees(wf_type):
    ...
    trees = {
        "compliance": [
            ...
            "If regulatory standard interpretation is unclear: web_search latest guidance, escalate to [YOUR NAME] if still ambiguous",
        ...
        "recruitment": [
            "If screening check returns concerns: escalate to [YOUR NAME] before proceeding",
    ...
    return trees.get(wf_type, [
        "If blocker exceeds 3 hours: escalate to [YOUR NAME]",
...
def generate_brief(answers, inferred):
    ...
    if answers.get("delivery_email"):
        ...
        lines.append(f"- Send from: sage@sonke.com.au via Microsoft Graph")
        lines.append("")
...
def main():
    ...
    # Optional: delivery
    delivery_defaults = {
        "compliance": "ruan@sonke.com.au",
        "incident": "ruan@sonke.com.au",
        "reconciliation": "ruan@sonke.com.au",
    }
    ...
    # ============================================================
    # SAGE FILLS THE REST — Intelligent defaults
    # ============================================================

    print("=" * 60)
    print("SAGE FILLING REMAINING FIELDS...")
    print("=" * 60)
    print()
    ...
    if wf_type == "compliance":
        audience += ", regulatory auditors if triggered"
