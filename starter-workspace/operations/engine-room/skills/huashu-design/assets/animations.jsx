 ...
 *   </Stage>
 *
 * Inside a Sprite child component, use useSprite() to read the current segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // Fast start + slow deceleration, gives numeric elements a sense of physical weight
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: elastic toggle/button pop-in (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
