 ...
 *
 * Used to present 2+ static design variations for comparison and selection.
 * Each variation has a label and can be expanded on hover.
 *
 * Usage:
 *   <DesignCanvas
 ...
 *     columns={3}
 *   >
 *     <Variation label="Minimal" description="Minimal and restrained">
 ...
 *   </DesignCanvas>
 *
 * Use with React + Babel. Place in an appropriate script tag;
 * window.DesignCanvas and window.Variation will then be available.
 */
