 ...
 *   - Background/graphics are 1:1 faithful (Playwright's embedded Chromium renderer)
 *   - No modifications to the HTML are required
 *   - Zero visual loss (PDF is exactly what the browser prints)
 *
 * Trade-off:
 *   - Text in the PDF is not editable (to edit, go back to the HTML source)
 *
