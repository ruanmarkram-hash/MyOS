...
Usage:
    ...
    python verify.py deck.html --slides 10                  # screenshot each slide (first 10)
    python verify.py design.html --output ./screenshots/   # output directory
    python verify.py design.html --show                    # non-headless, opens a real browser
...
def verify_html(html_path, viewports=None, slides=0, output_dir=None, show=False, wait=2000):
    ...
    with sync_playwright() as p:
        ...
        for viewport in viewports:
            ...
            if show:
                print("  (Browser window kept open — press Enter to close...)")
                input()
...
def main():
    ...
    parser.add_argument("--viewports", default="1440x900",
                        help="Comma-separated list of viewports, format WxH (default 1440x900)")
    parser.add_argument("--slides", type=int, default=0,
                        help="Slide mode: screenshot first N slides (requires HTML to support ArrowRight navigation)")
    parser.add_argument("--output", default=None,
                        help="Output directory (default: screenshots/ next to the HTML file)")
    parser.add_argument("--show", action="store_true",
                        help="Non-headless — opens a real browser window")
