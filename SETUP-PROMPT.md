...
3. **Ask me one question at a time** when you need information from me. Don't dump a checklist. Walk me through it.

4. **If you need credentials or API keys** (Supabase, Google, Telegram), give me the exact URL to visit, what to click when I'm there, and exactly what to paste back to you.

5. **Verify as you go.** After each major step, confirm it worked before moving on.

6. **If something breaks**, tell me plainly what failed and what we'll try next. Don't hide errors.
