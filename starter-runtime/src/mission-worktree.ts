 ...
 * Every Mason mission used to run in ~/HQ as cwd. When a mission did
 ...
 * ~/HQ/.worktrees/mission-<id>/, cut off the latest origin/main,
 * on a dedicated branch `mission-<id>`. The Mason runtime process keeps its
 * cwd at ~/HQ; only the mission's Claude Code subprocess sees the
