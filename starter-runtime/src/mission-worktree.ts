 ...
 * Every Mason mission used to run in ~/myos as cwd. When a mission did
 ...
 * ~/myos/.worktrees/mission-<id>/, cut off the latest origin/main,
 * on a dedicated branch `mission-<id>`. The Mason runtime process keeps its
 * cwd at ~/myos; only the mission's Codex subprocess sees the
