// ============================================================
// Pipeline reply handler (custom workflow staff-intake pipeline)
//
// Intercepts Telegram text replies on @custom assistant_bot when the reply
...
// complement for when user types back instead of tapping.
//
