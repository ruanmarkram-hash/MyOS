...
<div class="app">
  <header class="header" role="banner">
    <div class="left">
      <a class="back" href="/warroom${safeChatId ? `?chatId=${safeChatId}` : ''}" aria-label="Back to Mission Control" title="Back to Mission Control">←</a>
      <div class="brand">
...
async function loadEarlier() {
  ...
  try {
    ...
    if (CHAT_ID) params.set('chatId', CHAT_ID);
